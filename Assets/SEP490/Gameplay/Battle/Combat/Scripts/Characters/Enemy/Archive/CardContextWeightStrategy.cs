namespace SEP490G69.Battle.Combat
{
    ...
    public class CardContextWeightStrategy : ISelectCardStrategy
    {
        ...
        /// <returns></returns>
        public bool TrySelectCard(BaseCombatActor opponent, IReadOnlyList<CardSO> currentDrawPool, out CardSO card)
        {
            card = null;
            ...
            //float ownerCurrentHP = _owner.StatsManager.GetValue(EStatusType.Vitality);
            //float ownerMaxHP = _owner.ReadonlyDataHolder.GetVIT();
            //float ownerHPPercent = ownerCurrentHP / ownerMaxHP;

            //float opponentHP = opponent.StatsManager.GetValue(EStatusType.Vitality);

            //RuntimeStatusEffect[] ownerEffects = _owner.EffectsManager.GetEffectsByType(EEffectType.Both);
            //RuntimeStatusEffect[] opponentEffects = opponent.EffectsManager.GetEffectsByType(EEffectType.Both);
