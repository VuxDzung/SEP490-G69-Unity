namespace SEP490G69.Training
{
    ...
    public class StudyTrainingStrategy : BaseTrainingStrategy
    {
        public override bool StartTraining(CharacterDataHolder character)
        {
            ...
            var statReward = _exerciseDataHolder.GetSuccessRewardByType(EStatusType.Intelligence);
            float rawStatGain = statReward.Modifier != null ? statReward.Modifier.GetModifiedStatus(character.GetINT()) : 0f;
            ...
            if (isSuccess)
            {
                ...
                character.SetInt(facilityStatGain * moodMultiplier);
                return true;
            }
            else
            {
                ...
                character.SetInt(facilityStatGain * 0.1f);
                return false;
            }
        }
    }
