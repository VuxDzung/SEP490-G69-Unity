namespace SEP490G69.Training
{
    ...
    public class YogaTrainingStrategy : BaseTrainingStrategy
    {
        public override bool StartTraining(CharacterDataHolder character)
        {
            ...
            float rawStatGain = statReward.Modifier != null ? statReward.Modifier.GetRawStatGain(character.GetVIT()) : 0f;
            ...
            if (isSuccess)
            {
                ...
                character.AddVit(facilityStatGain * moodMultiplier);
                return true;
            }
            else
            {
                ...
                character.AddVit(facilityStatGain * 0.1f);
                return false;
            }
        }
    }
